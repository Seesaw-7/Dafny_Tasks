...
// The machine starts empty and has a capacity of 7 cokes.
...
/*{*/
  &&  numRestock >= 0
  &&  if v.numCokes + numRestock > c.capacity then (v'.numCokes == c.capacity)
      else v' == v.(numCokes := v.numCokes + numRestock )
/*}*/
}
